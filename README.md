...
Для пользователей приложения [LAMPA](https://github.com/yumata/lampa) доступен плагин, который добавляет возможность смотреть фильмы через Tape Operator.

### Установка плагина для LAMPA
